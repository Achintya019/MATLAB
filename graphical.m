...
y1 = 0  : h  : max(b);               %value of x1
x21 = (b(1) - A(1,1).*y1)./A(1,2);   %value of x2 from eq1 
x22 = (b(2) - A(2,1).*y1)./A(2,2);   %value of x2 from eq2 
x23 = (b(3) - A(3,1).*y1)./A(3,2);   %value of x2 from eq3
x21 = max(0 , x21);
x22 = max(0 , x22);
x23 = max(0 , x23);
...
%step 3 - find all corner points with axis
cx1 = find( y1 == 0 );
c1 = find( x21 ==  0);
